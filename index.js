      ...
      legend: {
        labels: {
          generateLabels: function(chart) {
            const length = Chart.defaults.global.legend.labels.generateLabels.apply(
              this,
              [chart]
            ).length;
...
const changeSize = (value) =>{
    renderCharts(parseInt(value))
}

document.getElementById("change-max-size").addEventListener("change",(event)=>{
